...
var LoadNPlayer = function (result) {
    ...
    if (!_xdomplayer) {
        rawPlayer += '<div class="video-caption-info video-fleft">'
    ...
    + '<div class="video-player-controls">'
        ...
        + '<div class="video-control-holder">'
            ...
            + '</div>'
    if (_fscr == 1) {
        rawPlayer += '<div class="video-control-holder video-fleft"><span class="video-fullscreen"></span>'
       + '</div>'
    }
    rawPlayer += '</div>'
...
function LoadClipPlayer(clipID, callback, ps, hcc) {
    ...
    var jsonPostData = { ClipID: clipID, HCC: hcc }
...
var LibraryLoadNPlayer = function (result) {
    ...
    if (result.isSuccess) {
        ...
        rawPlayer = rawPlayer + '<div class="video-container-narrow">'
    + '<div class="video-player-row-one">';
    ...
    + '<div class="video-video" id="divClipVideo">'
        + '<div class="video-abt-main">'
            + '<div class="video-abt-box">'
                + '<div class="video-abt-version">Video Player<br><span>Version: 1.34.44</span></div>'
                + '<div class="video-abt-logo" align="center"><img alt="iQ media" src="../../images/logo_N.png"></div>'
    ...
    + '<div class="video-player-controls">'
        ...
        if (_fscr == 1) {
            rawPlayer = rawPlayer + '<div class="video-control-holder video-fleft">'
            ...
            if (result.isSharing) {
                ...
                rawPlayer += '<div id="divEmbedForm" style="display:none">'
                            ...
                            + '<div id="divWordPressForm" style="display:none">'
                                + '<div class="embed-form">'
                                    + '<textarea class="video-clip-embed" id="txtWordPress" readOnly="true"><iframe src="' + _urlClipPlayer + _ID + '&ps=2" width="547" height="411" allowfullscreen="true" style="border:0 none;" /></textarea>'
                                + '</div>'
                                + '<div style="text-align:right; margin-right:0px;">'
