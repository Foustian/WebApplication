...
{
    // Base class. Contains functionality common to each email template class.
    public class EmailTemplateBaseDA
    {
        protected DataSet ExecuteSP(int? masterClientID, Guid? clientGuid, string archiveIDXml, string spName)
        {
            ...
            dataTypeList.Add(new DataType("@ArchiveIDXml", DbType.Xml, archiveIDXml, ParameterDirection.Input));
